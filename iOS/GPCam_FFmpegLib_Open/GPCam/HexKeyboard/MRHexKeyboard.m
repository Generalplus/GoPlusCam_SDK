...
- (MRHexKeyboard *)initWithTextField:(UITextField *)textField
{
    ...
    self = [super initWithFrame:CGRectMake(0.0f, 0.0f, screenWidth, kKeyboardHeight)];
...
- (void)createButtons
{
    ...
    [self makeButtonWithRect:rect title:@"Return" grayBackground:YES];
...
- (void)changeTextFieldText:(UIButton *)button
{
    if (_textField) {
        ...
        if (button.titleLabel.text) {
            if ([button.titleLabel.text isEqualToString:@"Return"]) {
