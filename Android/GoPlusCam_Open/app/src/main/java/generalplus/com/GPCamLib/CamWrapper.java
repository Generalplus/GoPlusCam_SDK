...
public class CamWrapper {
	...
	private static boolean m_bSupportPWlength = false;
	...
	public native int GPCamSendGetSetPIP(int i32Type);
	...
	public void setIsSupportPWlength(boolean bSupportPWlength)
	{
		m_bSupportPWlength = bSupportPWlength;
	}

	public boolean getIsSupportPWlength() {
		return m_bSupportPWlength;
	}
}
